...
func (app *application) accountView(w http.ResponseWriter, r *http.Request) {
	userID := app.sessionManger.GetInt(r.Context(), "authenticatedUserID")
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManger.Put(r.Context(), "flash", "Your password has been updated")
...
func (app *application) glystCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManger.Put(r.Context(), "flash", "Snippet successfully created")
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailEx), "email", "This field must be valid email address")
